								...
								<div class="row">
									<div class="col-xs-12">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
											<?php $no=1; foreach ($penjualan as $sale) { ?>
												<tr>
													<td><?php echo $no ?></td>
													<td><?php echo $sale->customername; ?></td>
													<td><?php echo $sale->orderdate; ?></td>
													<td><?php echo $sale->ordershipping; ?></td>
													<td><?php echo $sale->ordershippingdate; ?></td>
													<td><?php $amount = intval($sale->orderprice) + intval($sale->ordershippingcost); echo $sale->orderprice; ?></td>
												</tr>
												<?php $no++;} ?>
											</tbody>
										</table>
